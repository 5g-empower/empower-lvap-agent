...
struct empower_cqm_link {
  private:
    ...
    uint32_t _p_available_throughput;	/* p_available_bw [0-18000] */
  public:
    ...
    void set_p_available_throughput(uint32_t p_available_throughput) 	{ _p_available_throughput = htonl(p_available_throughput); }
