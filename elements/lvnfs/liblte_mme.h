...
*********************************************************************/
// Defines
#define LIBLTE_MME_ADDITIONAL_INFORMATION_MAX_N_OCTETS (LIBLTE_MAX_MSG_SIZE_BYTES/2)
// Enums
// Structs
typedef struct{
...
*********************************************************************/
// Defines
#define LIBLTE_MME_MAX_N_SUPPORTED_CODECS (LIBLTE_MAX_MSG_SIZE_BYTES/16)
// Enums
// Structs
typedef struct{
    uint8  sys_id;
